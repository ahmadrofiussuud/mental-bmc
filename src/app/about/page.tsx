            ...
            <main className="pt-32 pb-20 px-6">
                <div className="max-w-5xl mx-auto space-y-24">
                    <div className="space-y-8">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl font-black text-slate-900 tracking-tighter text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 items-center">
                            <div className="space-y-6">
                                ...
                                <Button className="rounded-full px-6 py-4 sm:px-8 sm:py-6 font-bold text-sm sm:text-base bg-slate-900">Bergabung dengan Perjalanan Kami</Button>
                            </div>
