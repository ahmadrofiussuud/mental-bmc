    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main>
                ...
                <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-indigo-50/20 pt-32 pb-20">
                    <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/natural-paper.png')] opacity-10" />

                    {/* Background Ambient Glow */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-200/30 rounded-full blur-[160px] -z-10" />
                    ...
                    <div className="max-w-5xl mx-auto px-6 md:px-12 w-full text-center space-y-16 relative z-10">
                        <div className="space-y-8">
                            ...
                            >
                                <Badge className="bg-indigo-100 text-indigo-700 px-8 py-3 rounded-full font-black uppercase text-sm tracking-[0.4em] border-2 border-indigo-200 shadow-xl shadow-indigo-500/10">
                                    Resilience Journey
                                </Badge>
                            </motion.div>
                            ...
                            <motion.h1
                                ...
                                className="text-5xl md:text-7xl lg:text-9xl font-black text-slate-900 tracking-[-0.07em] leading-[1.1] max-w-4xl mx-auto"
                            >
                                Evolusi <br />
                                <span className="text-indigo-600 italic">Diri Anda.</span>
                            </motion.h1>
                        ...
                        >
                            <div className="w-[500px] h-[500px] bg-white rounded-[100px] shadow-[0_120px_180px_-40px_rgba(79,70,229,0.2)] flex items-center justify-center p-16 ring-1 ring-slate-100 relative group">
                                <AvatarEvolution level={4} />

                                {/* Floating Badges around Avatar */}
                                <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 4, repeat: Infinity }} className="absolute -top-6 -right-6 bg-emerald-500 text-white p-6 rounded-3xl shadow-2xl border-4 border-white">
                                    <TrendingUp size={32} />
                                </motion.div>
                                <motion.div animate={{ y: [0, 15, 0] }} transition={{ duration: 5, repeat: Infinity, delay: 0.5 }} className="absolute -bottom-6 -left-6 bg-amber-500 text-white p-6 rounded-3xl shadow-2xl border-4 border-white">
                                    <Zap size={32} />
                                </motion.div>
                            </div>
                        </motion.div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-12 pt-8">
                            <div className="text-center group">
                                <p className="text-7xl font-black text-slate-900 tracking-tighter group-hover:scale-110 transition-transform">LVL 4</p>
                                <p className="text-[12px] font-black uppercase tracking-[0.5em] text-slate-400 mt-2">Current Stage</p>
                            </div>
                            <div className="hidden md:block w-px h-20 bg-slate-200" />
                            <div className="text-center group">
                                <p className="text-7xl font-black text-indigo-600 tracking-tighter group-hover:scale-110 transition-transform">240</p>
                                <p className="text-[12px] font-black uppercase tracking-[0.5em] text-slate-400 mt-2">Total XP Earned</p>
                            </div>
                        </div>

                        <Button className="bg-slate-900 hover:bg-black text-white px-16 py-12 rounded-[40px] font-black text-2xl shadow-2xl transition-all hover:scale-105 active:scale-95 group">
