...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
            ...
            <Card className="max-w-md w-full rounded-[30px] sm:rounded-[40px] border-none shadow-2xl shadow-indigo-100 p-5 sm:p-8 space-y-6 sm:space-y-8 bg-white/80 backdrop-blur-xl">
                <CardHeader className="text-center space-y-6">
                    <Link href="/" className="inline-flex items-center gap-2 group mx-auto">
                        ...
                        <span className="font-black text-2xl sm:text-3xl text-slate-900 tracking-tighter">TenangIn</span>
                    </Link>
                    <div className="space-y-2">
                        <CardTitle className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">Login ke Platform</CardTitle>
                        <p className="text-slate-500 font-medium text-xs sm:text-sm">Masukkan kredensial institusi Anda untuk melanjutkan.</p>
                    </div>
                </CardHeader>
                ...
                <CardContent className="space-y-6">
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="rounded-2xl bg-slate-50 border-none py-4 px-4 sm:py-6 sm:px-6 text-sm sm:text-base focus:ring-2 focus:ring-indigo-500 font-medium"
                                value={email}
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                type="password"
                                placeholder="••••••••"
                                className="rounded-2xl bg-slate-50 border-none py-4 px-4 sm:py-6 sm:px-6 text-sm sm:text-base focus:ring-2 focus:ring-indigo-500"
                                value={password}
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-slate-900 hover:bg-black text-white py-6 sm:py-8 rounded-2xl font-black text-base sm:text-lg shadow-xl shadow-slate-200 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                        >
                    ...
                    <div className="pt-6 border-t border-slate-100 space-y-4">
                        <div className="bg-indigo-50 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-indigo-100/50 space-y-3 sm:space-y-4">
