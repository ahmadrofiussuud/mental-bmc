        ...
        <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden py-20 sm:py-0">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 w-full relative z-10 text-center lg:text-left">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
              <div className="space-y-6 sm:space-y-8 lg:space-y-12 pt-24 sm:pt-28 md:pt-32 lg:pt-28 xl:pt-20">
                <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
                  ...
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white tracking-[-0.03em] sm:tracking-[-0.04em] leading-[1.4] sm:leading-[1.35] md:leading-[1.3] lg:leading-[1.25] drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
                    Mulai <br />
